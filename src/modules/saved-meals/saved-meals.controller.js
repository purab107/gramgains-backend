...
async function getAll(req, res) {
  try {
    const savedMeals = await SavedMealsService.getAll(req.userId);
...
async function getById(req, res) {
  try {
    const savedMeal = await SavedMealsService.getById(req.params.id, req.userId);
...
async function update(req, res) {
  try {
    const updated = await SavedMealsService.update(req.params.id, req.body, req.userId);
...
async function remove(req, res) {
  try {
    await SavedMealsService.remove(req.params.id, req.userId);
...
async function logToTracker(req, res) {
  try {
    ...
    const result = await SavedMealsService.logToTracker(req.params.id, date, mealType, req.userId);
